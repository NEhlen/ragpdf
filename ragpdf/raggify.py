...
from ragpdf.crop_funcs import Cropped
from ragpdf.image_funcs import (
    YOLO,
    CropperModel,
    compute_overlap,
    cutout_schemas_single_image,
)
...
def _evaluate_page(
    ...
    **kwargs,
    ...
    with Image.frombytes("RGB", [pix.width, pix.height], pix.samples) as img:
        crops_ml, _ = cutout_schemas_single_image(img, cropper)
...
def replace_images_in_pdf(
    pdf_path: str, method="florence", yolo_model: YOLO = None, **kwargs
):
